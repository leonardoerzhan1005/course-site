...
Route::group([
    'middleware' => ['guest:admin', \App\Http\Middleware\AdminLocaleMiddleware::class],
...
Route::group([
    ...
    Route::prefix('admin-training-applications')->group(function () {
        ...
        Route::get('/test-view', [AdminApplicationController::class, 'testView'])->name('applications.test.view');
        Route::post('/status/{id}', [AdminApplicationController::class, 'updateStatus'])->name('applications.status.update')->whereNumber('id');
        Route::get('/view/{id}', [AdminApplicationController::class, 'show'])->name('applications.show')->where('id', '[0-9]+')->whereNumber('id');
        Route::get('/test/{id}', [AdminApplicationController::class, 'test'])->name('applications.test')->whereNumber('id');
        Route::delete('/delete/{id}', [AdminApplicationController::class, 'destroy'])->name('applications.destroy')->whereNumber('id');
    });
...
Route::group([
    ...
    Route::resource('course-languages', CourseLanguageController::class)->parameters([
    ...
    Route::resource('course-categories', CourseCategoryController::class)->where(['course_category' => '[1-9][0-9]*']);
    Route::get('/{course_category}/sub-categories', [CourseSubCategoryController::class, 'index'])->where(['course_category' => '[1-9][0-9]*'])->name('course-sub-categories.index');
    Route::get('/{course_category}/sub-categories/create', [CourseSubCategoryController::class, 'create'])->where(['course_category' => '[1-9][0-9]*'])->name('course-sub-categories.create');
    Route::post('/{course_category}/sub-categories', [CourseSubCategoryController::class, 'store'])->where(['course_category' => '[1-9][0-9]*'])->name('course-sub-categories.store');
    Route::get('/{course_category}/sub-categories/{course_sub_category}/edit', [CourseSubCategoryController::class, 'edit'])->where(['course_category' => '[1-9][0-9]*', 'course_sub_category' => '[1-9][0-9]*'])->name('course-sub-categories.edit');

    Route::put('/{course_category}/sub-categories/{course_sub_category}', [CourseSubCategoryController::class, 'update'])->where(['course_category' => '[1-9][0-9]*', 'course_sub_category' => '[1-9][0-9]*'])->name('course-sub-categories.update');
    Route::delete('/{course_category}/sub-categories/{course_sub_category}', [CourseSubCategoryController::class, 'destroy'])->where(['course_category' => '[1-9][0-9]*', 'course_sub_category' => '[1-9][0-9]*'])->name('course-sub-categories.destroy');
    ...
    Route::get('course-contents', [CourseContentController::class, 'index'])->name('course-contents.index');
    Route::get('course-contents/{course}/manage', [CourseContentController::class, 'manage'])->name('course-contents.manage')->whereNumber('course');
    // Alias for Course Contents v2
    Route::get('course-contents-v2', [CourseContentV2Controller::class, 'index'])->name('course-contents-v2.index');
    Route::get('course-contents-v2/{course}/manage', [CourseContentV2Controller::class, 'manage'])->name('course-contents-v2.manage');
    Route::get('course-contents-v2/{course}/create-chapter', [CourseContentV2Controller::class, 'createChapterModal'])->name('course-contents-v2.chapters.create');
    Route::post('course-contents-v2/{course}/create-chapter', [CourseContentV2Controller::class, 'storeChapter'])->name('course-contents-v2.chapters.store');
    Route::get('course-contents-v2/{chapter}/edit-chapter', [CourseContentV2Controller::class, 'editChapterModal'])->name('course-contents-v2.chapters.edit');
    Route::post('course-contents-v2/{chapter}/edit-chapter', [CourseContentV2Controller::class, 'updateChapterModal'])->name('course-contents-v2.chapters.update');
    Route::delete('course-contents-v2/{chapter}/chapter', [CourseContentV2Controller::class, 'destroyChapter'])->name('course-contents-v2.chapters.destroy');

    Route::get('course-contents-v2/create-lesson', [CourseContentV2Controller::class, 'createLesson'])->name('course-contents-v2.lessons.create');
    Route::post('course-contents-v2/create-lesson', [CourseContentV2Controller::class, 'storeLesson'])->name('course-contents-v2.lessons.store');
    Route::get('course-contents-v2/edit-lesson', [CourseContentV2Controller::class, 'editLesson'])->name('course-contents-v2.lessons.edit');
    Route::post('course-contents-v2/{id}/update-lesson', [CourseContentV2Controller::class, 'updateLesson'])->name('course-contents-v2.lessons.update');
    Route::delete('course-contents-v2/{id}/lesson', [CourseContentV2Controller::class, 'destroyLesson'])->name('course-contents-v2.lessons.destroy');

    Route::post('course-contents-v2/chapter/{chapter}/sort-lesson', [CourseContentV2Controller::class, 'sortLesson'])->name('course-contents-v2.chapters.sort-lesson');
    Route::get('course-contents-v2/{course}/sort-chapter', [CourseContentV2Controller::class, 'sortChapter'])->name('course-contents-v2.sort-chapters');
    Route::post('course-contents-v2/{course}/sort-chapter', [CourseContentV2Controller::class, 'updateSortChapter'])->name('course-contents-v2.sort-chapters.update');
    ...
    Route::post('course-content/{course}/create-chapter', [CourseContentController::class, 'storeChapter'])
        ->whereNumber('course')
    ...
    Route::post('course-content/{id}/update-lesson', [CourseContentController::class, 'updateLesson'])
        ->whereNumber('id')
    ...
    Route::resource('application-faculties', ApplicationFacultyController::class)->parameters([
        'application-faculties' => 'application_faculty',
    ]);
    Route::resource('application-specialties', ApplicationSpecialtyController::class)->parameters([
        'application-specialties' => 'application_specialty',
    ]);
    Route::resource('application-countries', ApplicationCountryController::class)->parameters([
        'application-countries' => 'application_country',
    ]);
    Route::resource('application-cities', ApplicationCityController::class)->parameters([
        'application-cities' => 'application_city',
    ]);
    Route::resource('application-degrees', ApplicationDegreeController::class)->parameters([
        'application-degrees' => 'application_degree',
    ]);
    Route::resource('application-org-types', ApplicationOrgTypeController::class)->parameters([
        'application-org-types' => 'application_org_type',
    ]);
    Route::resource('application-course-languages', ApplicationCourseLanguageController::class)->parameters([
        'application-course-languages' => 'application_course_language',
    ]);
    // Application Courses settings
    Route::get('application-courses', [ApplicationCourseController::class, 'index'])->name('application-courses.index');
    Route::get('application-courses/{course}/edit', [ApplicationCourseController::class, 'edit'])->name('application-courses.edit')->whereNumber('course');
    Route::put('application-courses/{course}', [ApplicationCourseController::class, 'update'])->name('application-courses.update')->whereNumber('course');
